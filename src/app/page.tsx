...
import UploadButton from "@/components/sections/upload/UploadButton";
    ...
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-orange-50 to-amber-50/30">
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex justify-center mt-8 gap-4">
          <UploadButton file={file} loading={loading} onUpload={handleUpload} />
          {/* <QuizButton
            file={file}
            loading={loading}
            quizQuestions={quizQuestions}
            onGenerate={handleGenerateQuizz}
          /> */}
        </div>
